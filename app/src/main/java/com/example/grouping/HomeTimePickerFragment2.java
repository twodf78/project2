...
public class HomeTimePickerFragment2 extends DialogFragment implements TimePickerDialog.OnTimeSetListener {
    @Override
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        TextView tv = (TextView) getActivity().findViewById(R.id.homeFinishTimeTextView);
        String aMpM = "AM";
        if(hourOfDay >11){
            aMpM = "PM";
        }
